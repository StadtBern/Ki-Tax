...
public class Testfall_DoppelKita_Regel2 extends AbstractTestfall {
	...
	public Gesuch fillInGesuch() {
		...
		BetreuungspensumContainer betreuungspensumKitaAaregg2 = createBetreuungspensum(50, LocalDate.of(2017, Month.JANUARY, 1), LocalDate.of(2017, Month.JULY, 31));
		...
		BetreuungspensumContainer betreuungspensumKitaBruennen = createBetreuungspensum(50, LocalDate.of(2016, Month.OCTOBER, 1), LocalDate.of(2016, Month.DECEMBER, 31));
		...
		BetreuungspensumContainer betreuungspensumKitaBruennen2 = createBetreuungspensum(40, LocalDate.of(2017, Month.JANUARY, 1), LocalDate.of(2017, Month.JULY, 31));
