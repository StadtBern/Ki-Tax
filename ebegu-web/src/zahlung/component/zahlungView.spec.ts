...
import {EbeguWebZahlung} from '../zahlung.module';
import {TSBetreuungsangebotTyp} from '../../models/enums/TSBetreuungsangebotTyp';
import TestDataUtil from '../../utils/TestDataUtil';
import {ZahlungViewController} from './zahlungView';
...
describe('zahlungView', function () {

    let authServiceRS: AuthServiceRS;
    let gesuchRS: GesuchRS;
    let ebeguUtil: EbeguUtil;
    let mitteilungRS: MitteilungRS;
    let zahlungViewController: ZahlungViewController;
    let $q: IQService;
    let $scope: IScope;
    ...
    beforeEach(angular.mock.module(EbeguWebZahlung.name));
    ...
    describe('API Usage', function () {
        describe('getMitteilungen', function () {
            it('should return the list of Mitteilungen', function () {
                mockRestCalls();
                zahlungViewController = new ZahlungViewController(mitteilungRS, ebeguUtil, CONSTANTS, undefined);
                $scope.$apply();
                expect(mitteilungRS.getMitteilungenForZahlung).toHaveBeenCalled();
                let list: Array<TSMitteilung> = zahlungViewController.getMitteilungen();
    ...
    function mockGetMitteilung(): TSMitteilung {
        ...
        spyOn(mitteilungRS, 'getMitteilungenForZahlung').and.returnValue($q.when(dtoList));
